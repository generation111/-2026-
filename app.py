...
st.markdown("""
    ...
    .stTabs [data-baseweb="tab"] { font-size: 16px !important; font-weight: bold !important; color: #495057; }
...
def get_g_client():
    """連線邏輯：支援雲端 Secrets 與本地開發雙環境"""
    scope = ["https://www.googleapis.com/auth/spreadsheets", "https://www.googleapis.com/auth/drive"]
    
    # 優先嘗試讀取雲端 Secrets (GitHub 版)
    try:
...
def main():
    ...
    tab1, tab2, tab3 = st.tabs(["📝 快速錄入", "📊 年度數據清單", "🔔 預購追蹤"])
